...
public class DeleteDuplicate {
    ...
    public static void main(String[] args) {
        ...
        head = deleteDuplicate.insertNode(2, head);
        deleteDuplicate.insertNode(1, head);
        deleteDuplicate.insertNode(5, head);
        deleteDuplicate.insertNode(3, head);
        deleteDuplicate.insertNode(4, head);
        deleteDuplicate.insertNode(3, head);
        deleteDuplicate.insertNode(1, head);

        System.out.println("原链表：");
        deleteDuplicate.printList(head);
